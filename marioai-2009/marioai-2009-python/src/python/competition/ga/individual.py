...
class LevelScene(object):
    ...
    @classmethod
    def is_enemy(cls, code):
        return code == LevelSceneCode.enemy
...
class Individual(object):
    ...
    def gene_index_from_levelscene(self, levelscene, isMarioOnGround, mayMarioJump):
        ...
        cells_info = list(map(lambda cell: '1' if LevelScene.is_obstacle(cell) or LevelScene.is_enemy(cell) else '0', near_cells))
